...
contract IncrementalMerkleTree {
    ...
    uint32 public constant ROOT_SIZE_HISTORY = 30;
    ...
    /// @return index reutns the index of the leaf that was inserted
    function _insert(bytes32 _leaf) internal returns (uint32 index) {
        ...
        uint256 currentIndex = _insertedLeafIndex;
        ...
        uint32 newRootIndex = (s_currentRootIndex + 1) % ROOT_SIZE_HISTORY;
